...
export default function SignupPage() {
  ...
  async function handleSignup(event: FormEvent<HTMLFormElement>) {
    ...
    // Send the user straight to profile setup. When confirmation is enabled,
    // show the confirmation screen instead.
    if (data.session) {
      ...
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050b24] px-6 py-12 text-white">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-8 text-center shadow-2xl backdrop-blur-xl">
            ...
            <p className="mt-2 break-all font-bold text-white">{email}</p>

            <p className="mt-5 leading-7 text-slate-400">
              Confirm your email address, then log in to continue setting up
              your Studexa profile.
            </p>
        ...
        <div className="w-full max-w-xl">
          <div className="text-center">
            ...
            <h1 className="mt-7 text-4xl font-black tracking-tight md:text-5xl">
              Create your <span className="text-blue-500">student identity.</span>
            </h1>

            <p className="mx-auto mt-5 max-w-lg text-lg leading-8 text-slate-400">
              Build your professional profile, showcase your projects, share what
              you learn and grow your network.
            </p>
          </div>
          ...
          >
            <div>
              <label htmlFor="fullName" className="mb-2 block text-sm font-bold text-slate-200">
                Full name
              </label>
              <input
                id="fullName"
            ...
            <div className="mt-5">
              <label htmlFor="confirmPassword" className="mb-2 block text-sm font-bold text-slate-200">
                Confirm password
              </label>
              <input
                id="confirmPassword"
            ...
            >
              {loading ? "Creating your account..." : "Create your profile →"}
            </button>

            <p className="mt-5 text-center text-xs leading-6 text-slate-500">
              By creating an account, you agree to use Studexa responsibly.
            </p>
          </form>
